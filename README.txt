...
BKL APP V0.9.6
- BKL ist jetzt der übergeordnete Veranstaltungsdatensatz.
- QR/Checkpoints, Strecke/Live-Karte, Bonus, Regeln, Teilnahme/Zahlung werden logisch an einen angelegten BKL gebunden.
- Ohne angelegten BKL sind veranstaltungsbezogene Verwaltungsbereiche gesperrt.
- Konfigurationszentrale mit Vollständigkeitsprüfung.
- BKL VERÖFFENTLICHEN wird erst aktiv, wenn die Pflichtbereiche vollständig sind.
- Dauerhafter BKL-App-Werbe-QR bleibt veranstaltungsunabhängig.
- QR-Scanner-Seite mit echter Kameranutzung über die Browser-QR-Erkennung.
- Scanner nur bei laufendem BKL; Codes anderer Veranstaltungen werden abgewiesen.
- Fallback: normale Smartphone-Kamera kann die Token-URL weiterhin öffnen.
- supabase-v096.sql ergänzt die Scan-Protokollbasis.

Hinweis Scanner:
Der integrierte Kamerascanner nutzt BarcodeDetector, sofern der Browser diese Schnittstelle unterstützt.
Ist sie auf einem Gerät nicht verfügbar, bleibt der Scan über die normale Smartphone-Kamera funktionsfähig.
